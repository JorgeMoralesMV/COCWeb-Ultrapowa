...
<title><?=$myservername;?> - Game Masters</title>
</head>
<body>
<body>
...
<table width='100%' class='themain' border='0' align='center' cellpadding='1' cellspacing='1'>
    <tr>
      ...
      <td width='321' align='center' valign='top' class='topp2'><strong>Level</strong></td>
...
<?PHP
$sql=mysql_query("SELECT * FROM `player` WHERE AccountPrivileges <> 0 ");
